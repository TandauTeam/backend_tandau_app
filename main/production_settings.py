...
ALLOWED_HOSTS =['backendtandauapp-production.up.railway.app','http://backendtandauapp-production.up.railway.app','https://backendtandauapp-production.up.railway.app','127.0.0.1', 'localhost']
